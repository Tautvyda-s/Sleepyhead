...
import static com.example.sleepyhead.ui.AlarmLandingPageActivity.launchIntent;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //When notification popup, Ringtone service is started and ringtone will be played in background.
        Intent myService = new Intent(context, RingtonePlayingService.class);
