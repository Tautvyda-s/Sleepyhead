package com.example.sleepyhead.util;

import static com.example.sleepyhead.data.DatabaseHelper.COL_FRI;
import static com.example.sleepyhead.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.sleepyhead.data.DatabaseHelper.COL_MON;
import static com.example.sleepyhead.data.DatabaseHelper.COL_SAT;
import static com.example.sleepyhead.data.DatabaseHelper.COL_SUN;
import static com.example.sleepyhead.data.DatabaseHelper.COL_THURS;
import static com.example.sleepyhead.data.DatabaseHelper.COL_TIME;
import static com.example.sleepyhead.data.DatabaseHelper.COL_TUES;
import static com.example.sleepyhead.data.DatabaseHelper.COL_WED;
import static com.example.sleepyhead.data.DatabaseHelper._ID;
